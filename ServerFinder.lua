...
local LoopUntilLow = true

local ForgeWorldTwoId = 129009554587176

if game.PlaceId == ForgeWorldTwoId then
    RemoveErrorPrompts = false
end

task.spawn(function()
    repeat task.wait() until game:IsLoaded()
    if game.PlaceId == ForgeWorldTwoId then
        TeleportService:SetTeleportGui(TeleportService)
    end
end)
